...
num_mips_in_tail = num_mips_inside_tail(l2_data_block_size_256B, sw_typye);
...
{x_mip_micro_blolck[5],

y_mip_micro_blolck[5],

x_mip_micro_blolck[4],

y_mip_micro_blolck[4],

x_mip_micro_blolck[3],

y_mip_micro_blolck[3],

x_mip_micro_blolck[2],

y_mip_micro_blolck[2],

x_mip_micro_blolck[1],

y_mip_micro_blolck[1],

x_mip_micro_blolck[0],

y_mip_micro_blolck[0]} = byte_offset[BYTE_OFFSET_IN_MIPTAIL_WIDTH-1:8];
...
slice_times_z_h = slice_b[SLICE_WIDTH-B-1:16] * zb;
...
address_final = ({mipoffset_BaseAddress256B_out, 8'd0}) + addr_offset;
